...
export default class AddStaffMember extends React.Component {
    ...
    handleInputChange(event, inputPropName) {
        ...
        newState.managerId[inputPropName] = event.target.value;
        ...
        (
            {
              ...
              managerid: this.state.managerId.managerid,
        ...
        return (
           ...
           <form onSubmit={this.onSubmit} >
                    ...
                    <TextField
                        ...
                        value={this.state.managerId.managerid} onChange={event => this.handleInputChange(event, 'managerid')} />
                        </FormControl>
                    <br />
